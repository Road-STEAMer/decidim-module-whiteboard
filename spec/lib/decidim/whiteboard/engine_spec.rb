...
describe Decidim::Whiteboard::Engine do
  it_behaves_like "clean engine"

  describe "decidim_whiteboard.authorization_transfer" do
    ...
    let(:transferred_posts) { Decidim::Whiteboard::Post.where(author: target_user).order(:id) }
