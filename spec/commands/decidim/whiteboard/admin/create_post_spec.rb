  ...
  module Whiteboard
    module Admin
      describe CreatePost do
        ...
        let(:component) { create(:component, participatory_space: participatory_process, manifest_name: "whiteboard") }
        ...
        context "when everything is ok" do
          ...
          it "sends a notification to the participatory space followers" do
            ...
            expect(Decidim::EventsManager)
              .to receive(:publish)
              .with(
                event: "decidim.events.whiteboard.post_created",
                event_class: Decidim::Whiteboard::CreatePostEvent,
