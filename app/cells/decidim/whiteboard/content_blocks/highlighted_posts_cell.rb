  ...
  module Whiteboard
    module ContentBlocks
      class HighlightedPostsCell < Decidim::ContentBlocks::HighlightedElementsCell
        ...
        def posts
          @posts ||= Decidim::Whiteboard::Post.published.where(component: published_components).created_at_desc
        end

        def decidim_whiteboard
        ...
        def cache_hash
          hash = []
          hash << "decidim/whiteboard/content_blocks/highlighted_posts"
